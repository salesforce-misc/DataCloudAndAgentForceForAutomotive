...
//SetUp Steps
@track steps =[ 
    {id:1, title: 'Assign Permissions For Standard And Custom Object', description:'(Assign Read Access to Data Cloud Salesforce Connector Permission Set on Automotive object , Create an AgentUser, Create a Custom Field, Provide access to contact on Customer 360 Data Platform Integration Permission set )', buttonLabel:'Assign Permissions For Objects', active:true, disable: false},
    {id:2, title: 'Create Test Data', description:'(Create Automotive Sample data)', buttonLabel:'Create Test Data', active:false,disable: false},
    {id:3, title: 'Create Commerce Related Sample Data', description:'(Create Sample test data for commerce)', buttonLabel:'Create Commerce Data', active:false,disable: false},
    {id:4, title: 'Create Buyer Group Member', description:'(Create Buyer Group Member For Commerce)', buttonLabel:'Create Buyer Group Member Data', active:false,disable: false},
    {id:5, title: 'Create Order and Orderitem', description:'(Create Data for Order and OrderItems)', buttonLabel:'Create order and orderitem', active:false, disable: false},
    {id:6, title: 'Create Opportunity Data For ML', description:'(Create opportunity data for ML)', buttonLabel:'Create Opportunity Data', active:false, disable: false},
